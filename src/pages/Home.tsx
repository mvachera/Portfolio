...
function Home() {
	return (
		<div id="home" className="min-h-screen flex flex-col lg:flex-row justify-center items-center lg:space-x-6 px-4 lg:px-0 py-8 lg:py-0 mt-16 sm:mt-8 lg:mt-0">
			...
			<div className="flex flex-col w-full lg:w-1/2 text-center lg:text-left mb-8 lg:mb-0">
				<h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-white pb-3 font-extralight">
					Welcome
				</h1>
				<div className="relative pl-0 lg:pl-6">
					{/* Ligne gradient - visible seulement sur desktop */}
					<div className="absolute left-0 top-0 h-full w-[2px] bg-gradient-to-t from-yellow-400/80 to-transparent/10 hidden lg:block"></div>
			...
			<div className="w-full lg:w-auto lg:p-8 lg:pl-2 px-4">
				<h2 className="font-light text-xl lg:text-2xl font-bold text-white pb-3 mb-2 text-center lg:text-left">
					Projects
				</h2>
				<div className="relative pl-0 lg:pl-6 pt-2">
					
					{/* Éléments décoratifs - visibles seulement sur desktop */}
					<div className="absolute left-0 top-2 h-full w-[2px] bg-gradient-to-b from-yellow-400/80 via-yellow-400/20 to-transparent hidden lg:block"></div>
					<div className="absolute left-2 top-0 w-full h-[2px] bg-gradient-to-r from-yellow-400/80 via-yellow-400/20 to-transparent hidden lg:block"></div>
